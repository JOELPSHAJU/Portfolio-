...
import 'package:portfolio_client/src/protocol/portfolio_data.dart' as _i3;
import 'package:portfolio_client/src/protocol/greetings/greeting.dart' as _i4;
...
class EndpointPortfolio extends _i1.EndpointRef {
  ...
  _i2.Future<_i3.PortfolioData> getPortfolioData() =>
      caller.callServerEndpoint<_i3.PortfolioData>(
        'portfolio',
        'getPortfolioData',
        {},
      );

  _i2.Future<bool> submitInquiry({
